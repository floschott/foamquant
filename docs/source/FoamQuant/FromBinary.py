            ...
            for xi in range(len(xr)-1):
                ...
                if structured:
                    if count2>0:
                        ...
                        Mliqfrac[zi,yi,xi] = count0/(count0+count1+count2)
                    elif count0==0 and count1>0:
                        Mliqfrac[zi,yi,xi] = 0
                    elif count0>0 and count1==0:
                        Mliqfrac[zi,yi,xi] = 1    
                    ...
                    if count2>0:
                        ...
                        Mliqfrac.append(count0/(count0+count1+count2))
                    elif count0==0 and count1>0:
                        Mliqfrac.append(0)
                    elif count0>0 and count1==0:
                        Mliqfrac.append(1)
...
def LiqFrac_Batch(nameread, namesave, dirread, dirsave, imrange, TypeGrid='Global', Nz=None,Ny=None,Nx=None,Nr=None,Naz=None, crop=None, Masktype=[False,True], Mask=None, verbose=False, endread='.tif', endsave='.pkl', n0=3, structured=True):
    """
    ...
    for imi in imrange:
        ...
        if imi == imrange[0]:
            if len(np.shape(Mask))==0:
                ...
                if Masktype[1]>0 or Masktype[0]>0: #if should create a mask?
                    # outside mask
